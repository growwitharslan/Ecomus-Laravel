...
Route::get('/product', [ProductsController::class, 'productdetails'])->name('product.quick.view');
Route::get('/category', [CategoriesController::class, 'categorydetails'])->name('category.quick.view');

Route::get('/categories', [CategoriesController::class, 'category'])->name('category.view');

Route::get('/products', [ProductsController::class, 'Allproducts'])->name('products.view');
