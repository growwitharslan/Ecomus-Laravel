                ...
                <div class="container">
                    <div class="tf-breadcrumb-wrap d-flex justify-content-between flex-wrap align-items-center">
                        <div class="tf-breadcrumb-list">
                            <a href="{{ route ('home') }}" class="text">Products</a>
                            ...
                            <div class="tf-product-info-list other-image-zoom">
                                ...
                                <div class="tf-product-info-buy-button">
                                    <form action="{{ route('cart.store') }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="mt-3 w-100"> <!-- Added wrapper for new line -->
                                            <button type="submit"
                                                class="tf-btn btn-fill justify-content-center fw-6 fs-16 w-100 animate-hover-btn">
                            ...
                            <div class="swiper-slide" lazy="true">
                                <div class="card-product">
                                    <div class="card-product-wrapper">
                                        <a href=""
                                            class="product-img d-flex justify-content-center align-items-center"
                                            style="height: 200px;">
            ...
            <div class="modal-content">
                ...
                <div class="overflow-y-auto">
                    <ul class="tf-social-icon d-flex gap-10">
                        ...
                        <li><a href="#" class="box-icon social-twiter bg_line"><i class="icon icon-Icon-x"></i></a>
                        </li>
